VERSION 5.00
Begin VB.Form frmWP6 
   AutoRedraw      =   -1  'True
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "fx-500VN PLUS"
   ClientHeight    =   8715
   ClientLeft      =   495
   ClientTop       =   1050
   ClientWidth     =   4335
   Icon            =   "frmWP6.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmWP6.frx":45EAA
   ScaleHeight     =   581
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   289
   Tag             =   "207"
...
Private Sub Form_Unload(Cancel As Integer)
    'EndPlaySound
    If keyCodeOutPut.Visible = True Then Unload keyCodeOutPut
...
Private Sub pButton_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Case 10
        keyCodeOutPut.btnShowList.AddItem "[log¡ö¡õ]"
    Case 11
    ...
    Case 13
        ...
        If ShiftPower = True Then
            keyCodeOutPut.btnShowList.AddItem "((¡ö))"
        Else
        End If
