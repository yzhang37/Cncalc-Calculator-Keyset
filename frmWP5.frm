VERSION 5.00
Begin VB.Form frmWP5 
   AutoRedraw      =   -1  'True
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "fx-86DE PLUS"
   ClientHeight    =   8715
   ClientLeft      =   495
   ClientTop       =   1050
   ClientWidth     =   4335
   Icon            =   "frmWP5.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmWP5.frx":45EAA
   ScaleHeight     =   581
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   289
   Tag             =   "206"
...
Private Sub mnuBaseKey_Click(Index As Integer)
    ...
    If .ListIndex <= -1 Then
    .AddItem mnuBaseKey(Index).Caption
    .Selected(.ListCount - 1) = True
    Else
    .AddItem mnuBaseKey(Index).Caption, .ListIndex + 1
...
Private Sub pButton_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Case 7
        ...
        If ShiftPower = True Then
            keyCodeOutPut.btnShowList.AddItem "(÷R)"
        Else
        End If
    ...
    '============================Number Key============================
         ...
         Case 29
             ...
             If ShiftPower = True Then
            keyCodeOutPut.btnShowList.AddItem "(CONST)"
        Else
        End If
         Case 30
             keyCodeOutPut.btnShowList.AddItem "[8]"
             If ShiftPower = True Then
                keyCodeOutPut.btnShowList.AddItem "(CONV)"
                Else
             End If
         Case 31
         ...
         Case 41
            ...
            If ShiftPower = True Then
                keyCodeOutPut.btnShowList.AddItem "(BASE)"
            Else
            End If
         Case 42
             keyCodeOutPut.btnShowList.AddItem "[+]"
         ...
         Case 46
            ...
            If ShiftPower = True Then
                keyCodeOutPut.btnShowList.AddItem "(π)"
            ElseIf AlphaPower = True Then
                keyCodeOutPut.btnShowList.AddItem "(e)"
            Else
