VERSION 5.00
Begin VB.Form frmWP1 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "fx-82ES PLUS"
   ClientHeight    =   8715
   ClientLeft      =   495
   ClientTop       =   1050
   ClientWidth     =   4335
   Icon            =   "frmWP1.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   Picture         =   "frmWP1.frx":45EAA
   ScaleHeight     =   581
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   289
   Tag             =   "101"
