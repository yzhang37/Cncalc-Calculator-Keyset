...
Begin VB.Form frmWP2 
   ...
   ClientTop       =   1050
   ClientWidth     =   4335
   Icon            =   "frmWP2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   Picture         =   "frmWP2.frx":45EAA
   ScaleHeight     =   581
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   289
   Tag             =   "101"
...
Private Sub Form_Load()
    Ax = 200
    bc = False
    Me.Picture = LoadResPicture(Ax + Val(Me.Tag), 0)
     '***************** Ðë¸´ÖÆ
