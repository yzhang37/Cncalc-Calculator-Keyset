...
Begin VB.UserControl jcbutton 
   ...
   EndProperty
   PropertyPages   =   "jcButton.ctx":0000
   ScaleHeight     =   25
   ScaleMode       =   3  '像素
   ScaleWidth      =   89
End
...
Attribute BackColor.VB_Description = "返回/设置对象的背景色。"
...
Attribute ButtonStyle.VB_Description = "返回/设置对象的外观界面。"
...
Attribute CaptionAlign.VB_Description = "返回/设置对象标签的位置。"
...
Attribute DropDownSymbol.VB_Description = "返回/设置对象显示弹出菜单的箭头。"
...
Attribute DropDownSeparator.VB_Description = "返回/设置对象如何显示箭头分隔条。"
Attribute DropDownSeparator.VB_ProcData.VB_Invoke_Property = "General"
...
Attribute DisabledPictureMode.VB_Description = "返回/设置 the effect to be used for picture when button is disabled."
...
Attribute Enabled.VB_Description = "返回/设置 a value to determine whether the button can respond to events."
...
Attribute Font.VB_Description = "返回/设置对象上显示文本的字体。"
...
Attribute ForeColor.VB_Description = "返回/设置对象上显示的字符的颜色。"
...
Attribute ForeColorHover.VB_Description = "返回/设置当鼠标移过对象时显示的字符的颜色。"
...
Attribute HandPointer.VB_Description = "返回/设置 a value to determine whether the control uses the system's hand pointer as its cursor."
Attribute HandPointer.VB_ProcData.VB_Invoke_Property = "General"
...
Attribute MaskColor.VB_Description = "返回/设置 a color in a button's picture to be transparent."
...
Attribute Mode.VB_Description = "返回/设置 the type of control the button will observe."
...
Attribute MousePointer.VB_Description = "返回/设置 the type of mouse pointer displayed when cursor over the button."
...
Attribute PictureNormal.VB_Description = "返回/设置 the picture displayed on a normal state button."
...
Attribute PictureHot.VB_Description = "返回/设置 the picture displayed when the cursor is over the control."
...
Attribute PictureDown.VB_Description = "返回/设置 the picture displayed when the control is pressed down or in checked state."
...
Attribute PictureAlign.VB_Description = "返回/设置 a value to determine where to draw the picture in the button."
...
Attribute PictureShadow.VB_Description = "返回/设置 a value to determine whether to display Picture Shadow"
Attribute PictureShadow.VB_ProcData.VB_Invoke_Property = "Pictures"
...
Attribute PictureEffectOnOver.VB_Description = "返回/设置 the Picture Effects to be applied when the mouseis over the control."
...
Attribute PictureEffectOnDown.VB_Description = "返回/设置 the Picture Effects to be applied when the Button is pressed down."
...
Attribute PicturePushOnHover.VB_Description = "返回/设置 a value to determine whether to Push picture when Mouse is over the control."
Attribute PicturePushOnHover.VB_ProcData.VB_Invoke_Property = "Pictures"
...
Attribute PictureOpacity.VB_Description = "返回/设置 a byte value to control the Opacity of the Picture."
Attribute PictureOpacity.VB_ProcData.VB_Invoke_Property = "Pictures"
...
Attribute PictureOpacityOnOver.VB_Description = "返回/设置 a byte value to control the Opacity of the Picture when Mouse is over the button."
Attribute PictureOpacityOnOver.VB_ProcData.VB_Invoke_Property = "Pictures"
...
Attribute RightToLeft.VB_Description = "返回/设置 a value to determine whether to display text in RTL mode."
Attribute RightToLeft.VB_ProcData.VB_Invoke_Property = "General"
...
Attribute CaptionEffects.VB_Description = "返回/设置对象标签的特殊显示效果。"
...
Attribute ShowFocusRect.VB_Description = "返回/设置 a value to show Focusrect when the button has focus"
...
Attribute UseMaskColor.VB_Description = "返回/设置 a value to determine whether to use MaskColor to create transparent areas of the picture."
...
Attribute Value.VB_Description = "返回/设置 the value or state of the button."
...
Attribute TooltipTitle.VB_Description = "返回/设置 the text displayed in the title of the tooltip."
Attribute TooltipTitle.VB_ProcData.VB_Invoke_Property = "ToolTips"
...
Attribute ToolTip.VB_Description = "返回/设置 the text displayed when mouse is paused over the control."
Attribute ToolTip.VB_ProcData.VB_Invoke_Property = "ToolTips"
...
Attribute TooltipBackColor.VB_Description = "返回/设置 color to be displayed in the tooltip."
...
Attribute ToolTipIcon.VB_Description = "返回/设置 an icon value to be displayed in the tooltip."
...
Attribute ToolTipType.VB_Description = "返回/设置 the Style of the tooltip."
...
Attribute ColorScheme.VB_Description = "返回/设置 the ColorScheme to be used for the Background color."
